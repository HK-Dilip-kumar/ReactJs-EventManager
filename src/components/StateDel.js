...
class StateDel extends Component {
    state = {
        events: [
    ...
    render() {
        return (
            <div>
                ...
                <table border="1px solid black" className="table">
                    <thead>
                        <tr>
                            <th> Id</th><th> Event</th><th> Category</th><th> Price</th><th>Date</th><th>Select</th><th>Operations</th>
                        </tr></thead>
                    {
                        this.state.events.map(x =>
                            <tr>
                                ...
                                <td><a href="#" onClick={() => this.deleteRowById(x.id)}>DELETE ROW</a></td>
                            </tr>)}
                </table>
                <hr />
                ...
                <button style={{ marginLeft: "48%" }} className="btn btn-danger" onClick={() => this.ClearAll()}>Clear All</button>
            </div>)
    }
}
export default StateDel;