    ...
    render() {
        return (
            <div>
                ...
                <p style={{ marginLeft: "51%", color: "red" }}><button onClick={() => this.addRow()} className="btn btn-success">Add</button></p>
                <button style={{ marginLeft: "50%" }} className="btn btn-danger" onClick={() => this.ClearAll()}>Clear All</button>
            </div>)
    }
}
